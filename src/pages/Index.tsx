      ...
      <main className="md:ml-64 p-6">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <section className="text-center mb-12">
            <div className="bg-gradient-primary p-8 rounded-2xl shadow-elegant text-primary-foreground">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Welcome to StyleMe
              </h1>
              <p className="text-xl mb-6 opacity-90">
                Your AI-powered wardrobe assistant that suggests perfect outfits based on weather and occasions
              </p>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Today's Suggestions */}
              <section>
                <OutfitSuggestions weather={weather} />
              </section>
                  ...
                  <Card className="shadow-soft">
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="p-3 bg-accent rounded-lg mt-4">
                          <p className="text-sm text-accent-foreground">
                            Perfect weather for light layers and comfortable shoes!
                          </p>
                        </div>
                      </div>
                    </CardContent>
